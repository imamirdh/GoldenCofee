...
function CofeClub() {
  return (
    <div className="container lg:py-20 py-8">
      <div className="w-full lg:h-[144px] cofeclubbg rounded-2xl shadow-sm flex-wrap lg:flex lg:flex-nowrap items-center px-3">
        <div className="lg:w-1/2 w-full flex items-center">
          <img
            src="/images/club/diamond.png"
            alt=""
            className="lg:my-[23px] my-[34px] lg:ms-11  me-6 lg:w-[110px] lg:h-[98px] w-[87px] h-[78px]"
          />
          <div className="bodyright font-Morabba text-white">
            <h1 className="lg:text-5xl text-2xl lg:leading-[48px] leading-7 font-MorabbaBold italic">
              کافی کلاب
            </h1>
            <p className="lg:text-2xl text-lg leading-7 lg:leading-[48px] italic">
              میدونستی میتونی با امتیاز هات قهوه بگیری ؟
            </p>
          </div>
        </div>
        <div className="lg:w-1/2 w-full flex items-center justify-between font-Dana  lg:mx-0 pb-5 lg:pb-0 ">
          <div className="flex items-center lg:gap-5 gap-2 child:lg:w-[98px] child:lg:h-[98px] child:bg-white child:text-emerald-600 child:rounded-2xl
          child:w-[72px] child:h-[72px] ">
            <div className="">
              <svg
                className="mx-auto lg:mt-5 mt-[6px] lg:mb-3 mb-[3px]"
                width="40"
                height="40"
                viewBox="0 0 40 40"
                fill="none"
              ...
              <p className="lg:text-[14px] text-[12px] leading-5 text-center font-normal mb-1">چرخ و بخت</p>
            </div>
            <div className="">
              <svg
                className="mx-auto lg:mt-5 mt-[6px] lg:mb-3 mb-[3px]"
              ...
              <p className="lg:text-[14px] text-[12px] leading-5 text-center font-normal mb-1">ماموریت ها</p>
            </div>
            <div className="">
              <svg
                className="mx-auto lg:mt-5 mt-[6px] lg:mb-3 mb-[3px]"
              ...
              <p className="lg:text-[14px] text-[12px] leading-5 text-center font-normal mb-1 ">جایزه ها</p>
            </div>
          </div>
          <div className="lg:me-11 text-white">
            <div className="mb-2">
                <p className="lg:text-3xl text-xl  font-semibold lg:leading-[42px] leading-[24px]">542</p>
                <p className="lg:text-[14px] text-[12px] lg:leading-5 leading-[17px]">امتیـــــــاز شما</p>
            </div>
            <button className="flex items-center text-[12px] lg:text-[14px] cofeclubbtnbg rounded-full lg:px-3 px-1 lg:py-[6px] py-1 font-normal">
                دریافت جایزه<IoIosArrowBack/>
            </button>
          </div>
        </div>
      </div>
